<template>
  <div class="yin-header">
    ...
    <!--新增：AI超链接，与导航栏样式一致-->
    <a href="https://suno.com" target="_blank" class="nav-item ai-link">AI</a>
    <!--设置-->
...
/* 新增：AI链接样式（使用主题色，移除未定义变量） */
.ai-link {
  display: inline-block;
  padding: 0 1rem;
  color: $theme-color; /* 使用已定义的主题色 */
  ...
  &:hover {
    color: darken($theme-color, 15%); /* 动态计算深色，需确保主题色已定义 */
